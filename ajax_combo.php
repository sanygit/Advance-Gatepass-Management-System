	...
	$lookups = array(   
		'gatepass' => array(   
			...
			'invited_by' => array(
				'parent_table' => 'staff',
				'parent_pk_field' => 'id',
				'parent_caption' => 'IF(CHAR_LENGTH(`staff`.`full_name`) || CHAR_LENGTH(`staff`.`national_id`), CONCAT_WS(\'\', `staff`.`full_name`, \' :\', `staff`.`national_id`), \'\')',
				'parent_from' => '`staff` ',
				'filterers' => array(),
				'custom_query' => '',
				'inherit_permissions' => false,
			...
			'individual' => array(
				'parent_table' => 'individuals',
				'parent_pk_field' => 'id',
				'parent_caption' => 'IF(CHAR_LENGTH(`individuals`.`full_name`) || CHAR_LENGTH(`individuals`.`national_id`), CONCAT_WS(\'\', `individuals`.`full_name`, \' :\', `individuals`.`national_id`), \'\')',
				'parent_from' => '`individuals` ',
				'filterers' => array(),
				'custom_query' => '',
				'inherit_permissions' => false,
				'list_type' => 0,
			...
			'group' => array(
				'parent_table' => 'kikundi',
				'parent_pk_field' => 'id',
				'parent_caption' => '`kikundi`.`group_name`',
				'parent_from' => '`kikundi` ',
				'filterers' => array(),
				'custom_query' => '',
				'inherit_permissions' => false,
			...
			'vehicle' => array(
				...
				'parent_pk_field' => 'id',
				'parent_caption' => '`vehicles`.`reg_number`',
				'parent_from' => '`vehicles` ',
				'filterers' => array(),
				'custom_query' => '',
				'inherit_permissions' => false,
				'list_type' => 0,
			...
			'luggage' => array(
				'parent_table' => 'luggage',
				'parent_pk_field' => 'id',
				'parent_caption' => 'IF(CHAR_LENGTH(`luggage`.`type`) || CHAR_LENGTH(`luggage`.`name`), CONCAT_WS(\'\', `luggage`.`type`, \' :\', `luggage`.`name`), \'\')',
				'parent_from' => '`luggage` ',
				'filterers' => array(),
				'custom_query' => '',
				'inherit_permissions' => false,
