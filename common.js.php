...
function gatepass_validateData(){
	$j('.has-error').removeClass('has-error');
	/* Field gate can't be empty */
	if($j('#gate').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> gate", close: function(){ $j('[name=gate]').focus().parents('.form-group').addClass('has-error'); } }); return false; };
	/* Field purpose_of_visit can't be empty */
	if($j('#purpose_of_visit').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Purpose_Of_Visit", close: function(){ $j('[name=purpose_of_visit]').focus().parents('.form-group').addClass('has-error'); } }); return false; };
	return true;
}
function gates_validateData(){
	$j('.has-error').removeClass('has-error');
...
function individuals_validateData(){
	$j('.has-error').removeClass('has-error');
	/* Field full_name can't be empty */
	if($j('#full_name').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> FullName", close: function(){ $j('[name=full_name]').focus().parents('.form-group').addClass('has-error'); } }); return false; };
	/* Field national_id can't be empty */
	if($j('#national_id').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> National_ID", close: function(){ $j('[name=national_id]').focus().parents('.form-group').addClass('has-error'); } }); return false; };
	/* Field phone_number can't be empty */
	if($j('#phone_number').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Phone_Number", close: function(){ $j('[name=phone_number]').focus().parents('.form-group').addClass('has-error'); } }); return false; };
	/* Field gender can't be empty */
	if($j('#gender').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Gender", close: function(){ $j('[name=gender]').focus().parents('.form-group').addClass('has-error'); } }); return false; };
	return true;
}
function kikundi_validateData(){
	$j('.has-error').removeClass('has-error');
	/* Field group_name can't be empty */
	if($j('#group_name').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> GroupName", close: function(){ $j('[name=group_name]').focus().parents('.form-group').addClass('has-error'); } }); return false; };
	return true;
}
function luggage_validateData(){
	$j('.has-error').removeClass('has-error');
	/* Field type can't be empty */
	if($j('#type').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Type", close: function(){ $j('[name=type]').focus().parents('.form-group').addClass('has-error'); } }); return false; };
	/* Field name can't be empty */
	if($j('#name').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Name", close: function(){ $j('[name=name]').focus().parents('.form-group').addClass('has-error'); } }); return false; };
	return true;
}
...
function vehicles_validateData(){
	$j('.has-error').removeClass('has-error');
	/* Field reg_number can't be empty */
	if($j('#reg_number').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Reg_Number", close: function(){ $j('[name=reg_number]').focus().parents('.form-group').addClass('has-error'); } }); return false; };
	return true;
}
...
function persist_expanded_child(id){
	var expand_these = Cookies.getJSON('GPMS.dvp_expand');
	...
	if($j('[id=' + id + ']').hasClass('active')){
		if(expand_these.indexOf(id) < 0){
			...
			Cookies.set('GPMS.dvp_expand', expand_these, { expires: 30 });
		}
	}else{
		if(expand_these.indexOf(id) >= 0){
