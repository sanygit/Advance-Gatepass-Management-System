	...
	*/
	...
	$schema = array(   
		'gatepass' => array(   
			...
			'entry_time' => array('appgini' => 'TIME '),
			'exit_time' => array('appgini' => 'TIME '),
			'gate' => array('appgini' => 'INT(10) unsigned not null '),
			'purpose_of_visit' => array('appgini' => 'TEXT not null '),
			'invited_by' => array('appgini' => 'INT(10) '),
			'staff' => array('appgini' => 'INT(10) '),
			'individual' => array('appgini' => 'INT(10) unsigned '),
			'group' => array('appgini' => 'INT(10) unsigned '),
			'vehicle' => array('appgini' => 'INT(10) '),
			'luggage' => array('appgini' => 'INT(10) unsigned '),
			'date' => array('appgini' => 'DATE '),
			'status' => array('appgini' => 'VARCHAR(40) '),
			'reason' => array('appgini' => 'TEXT ')
		),
		'gates' => array(   
			'id' => array('appgini' => 'INT(10) unsigned not null primary key auto_increment '),
		...
		'individuals' => array(   
			...
			'national_id' => array('appgini' => 'VARCHAR(40) not null '),
			'phone_number' => array('appgini' => 'VARCHAR(40) not null '),
			'gender' => array('appgini' => 'VARCHAR(40) not null ')
		),
		'kikundi' => array(   
			'id' => array('appgini' => 'INT(10) unsigned not null primary key auto_increment '),
			'group_name' => array('appgini' => 'VARCHAR(40) not null '),
			'members' => array('appgini' => 'TEXT ')
		),
		'luggage' => array(   
			'id' => array('appgini' => 'INT(10) unsigned not null primary key auto_increment '),
			'type' => array('appgini' => 'VARCHAR(40) not null '),
			'name' => array('appgini' => 'VARCHAR(40) not null '),
			'owner' => array('appgini' => 'VARCHAR(40) ')
		),
		'staff' => array(   
			'id' => array('appgini' => 'INT(10) not null primary key auto_increment '),
			'full_name' => array('appgini' => 'VARCHAR(40) not null '),
			'national_id' => array('appgini' => 'VARCHAR(40) not null '),
			'department' => array('appgini' => 'VARCHAR(40) '),
			'phone_number' => array('appgini' => 'VARCHAR(40) not null '),
			'gender' => array('appgini' => 'VARCHAR(40) not null ')
		),
		'vehicles' => array(   
			'id' => array('appgini' => 'INT(10) not null primary key auto_increment '),
			'reg_number' => array('appgini' => 'VARCHAR(40) not null ')
		)
	);
