		...
		$all_tables = array(
			/* ['table_name' => [table props assoc array] */   
				...
				'gates' => array(
					'Caption' => 'gates',
					'Description' => '',
					'tableIcon' => 'resources/table_icons/attribution.png',
					'group' => $tg[0],
					'homepageShowCount' => 0
				),
				'individuals' => array(
				...
				'luggage' => array(
					'Caption' => 'luggage',
					'Description' => '',
					'tableIcon' => 'resources/table_icons/computer.png',
					'group' => $tg[0],
					'homepageShowCount' => 0
				),
				'staff' => array(
					'Caption' => 'staff',
					'Description' => '',
					'tableIcon' => 'resources/table_icons/angel.png',
					'group' => $tg[0],
					'homepageShowCount' => 0
				),
				'vehicles' => array(
					'Caption' => 'vehicles',
					'Description' => '',
					'tableIcon' => 'resources/table_icons/autos.png',
					'group' => $tg[0],
					'homepageShowCount' => 0
				)
		);
